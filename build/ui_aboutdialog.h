...
"Copyright &copy; 2011-YYYY The GoodsCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About GoodsCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>GoodsCoin</b> version", 0));
